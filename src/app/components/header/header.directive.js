...
angular.module('matrizOdSube').directive('brandHeader', ['$timeout', brandHeader]);

function brandHeader($timeout) {
    // Runs during compile
    console.log("directive brandHeader compiled");
    return {
        ...
        link: function($scope, iElm, iAttrs) {
            ...
            console.log("directive brandHeader linked");
        }
    };
}
