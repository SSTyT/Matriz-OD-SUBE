...
angular.module('matrizOdSube').directive('destinationList', ['$timeout','DataOrigin', destinationList]);

function destinationList($timeout,DataOrigin) {
    // Runs during compile
    console.log("directive destinationList compiled");
    return {
        ...
        templateUrl: 'app/components/odm/panel.right/destination.list/destination.list.tpl.html',
        replace: true,
        ...
        link: function($scope, iElm, iAttrs) {
            ...
            console.log("directive destinationList linked");
        }
    };
}
