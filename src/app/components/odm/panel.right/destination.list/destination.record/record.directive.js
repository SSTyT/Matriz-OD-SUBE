...
angular.module('matrizOdSube').directive('destinationRecord', ['$timeout', destinationRecord]);

function destinationRecord($timeout) {
    // Runs during compile
    console.log("directive destinationRecord compiled");
    return {
        ...
        templateUrl: 'app/components/odm/panel.right/destination.list/destination.record/record.tpl.html',
        replace: true,
