...
angular.module('matrizOdSube').directive('resume', ['$timeout','DataOrigin', resume]);

function resume($timeout,DataOrigin) {
    // Runs during compile
    console.log("directive resume compiled");
    return {
        ...
        templateUrl: 'app/components/odm/panel.right/resume/resume.tpl.html',
        replace: true,
        ...
        link: function($scope, iElm, iAttrs) {
            ...
            console.log("directive resume linked");
        }
    };
}
