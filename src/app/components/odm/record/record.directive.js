...
angular.module('matrizOdSube').directive('odRecord', ['$timeout', odRecord]);

function odRecord($timeout) {
    // Runs during compile
    console.log("directive odRecord compiled");
    return {
        ...
        templateUrl: 'app/components/odm/record/record.tpl.html',
        replace: true,
