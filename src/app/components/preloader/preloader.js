...
angular.module('matrizOdSube').directive('odPreloader', ['$timeout', OdPreloader]);

function OdPreloader($timeout) {
    // Runs during compile
    console.log("directive OdPreloader compiled");
    return {
        ...
        link: function($scope, iElm, iAttrs) {
            ...
            $scope.preloder = {
                active : false , 
                show : function (){
                    $scope.preloder.active = active;
                },
                hide : function (){
                    $scope.preloder.active = ''; 
                }
            } ;


            console.log("directive OdPreloader linked");
        }
    };
}
